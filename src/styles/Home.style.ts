...
// types
import type { StyledImageProps } from '@/types/styled';
...
export const Logo = styled(Image)<StyledImageProps>(tw`dark:invert`);
...
export const ContentInnerImage = styled(Image)<StyledImageProps>(
